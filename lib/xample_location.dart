        ...
        children: <Widget>[
          ...
          Center(
            child: ElevatedButton(
              ...
              child: const Text('Get last known position'),
            ),
          ),
          sizedBox,
          Center(
          ...
          Center(
            child: ElevatedButton(
              ...
              child: const Text('Get location accuracy'),
            ),
          ),
          sizedBox,
          Center(
            child: ElevatedButton(
              ...
              child: const Text('Request temporary full accuracy'),
            ),
          ),
          sizedBox,
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                switch (positionItem.type) {
                  ...
                  case _PositionItemType.position:
                    return ListTile(
                      title: Text(positionItem.displayValue),
                      trailing: IconButton(
                        ...
                        onPressed: () {
                          Clipboard.setData(
                            ClipboardData(text: positionItem.displayValue),
                          );
                        },
                      ),
                    );
